...
html {
  ...
  scrollbar-color: rgba(212, 218, 229, 0.5) transparent; }
...
.euiComboBoxOptionsList {
  ...
  .euiComboBoxOptionsList .ReactVirtualized__List {
    ...
    .euiComboBoxOptionsList .ReactVirtualized__List::-webkit-scrollbar-thumb {
      background-color: rgba(212, 218, 229, 0.5);
...
.euiFlyoutFooter {
  -webkit-box-shadow: 0 -16px 16px -8px #1D1E24;
          box-shadow: 0 -16px 16px -8px #1D1E24;
  z-index: 2;
  background: #25262E;
  -webkit-box-flex: 0;
      -ms-flex-positive: 0;
...
.euiRange__level--warning {
  background-color: rgba(255, 151, 122, 0.3); }
...
.euiRange__wrapper--hasTicks .euiRange::-webkit-slider-runnable-track {
  background-color: rgba(212, 218, 229, 0.4);
  border-color: rgba(212, 218, 229, 0.4); }
...
.euiLink.euiLink--subdued {
  ...
  .euiLink.euiLink--subdued:focus {
    outline: solid 3px rgba(212, 218, 229, 0.1);
    background-color: rgba(212, 218, 229, 0.1); }
...
.euiLink.euiLink--warning {
  ...
  .euiLink.euiLink--warning:focus {
    outline: solid 3px rgba(255, 151, 122, 0.1);
    background-color: rgba(255, 151, 122, 0.1); }
