...
exports.MonitorStatusBar = ({ timestamp, url, duration, status }) => (react_2.default.createElement(eui_1.EuiPanel, null,
    react_2.default.createElement(eui_1.EuiFlexGroup, { gutterSize: "l" },
        ...
        !!duration && (react_2.default.createElement(eui_1.EuiFlexItem, { "aria-label": i18n_1.i18n.translate('xpack.uptime.monitorStatusBar.durationTextAriaLabel', {
            ...
            react_2.default.createElement(react_1.FormattedMessage, { id: "xpack.uptime.monitorStatusBar.healthStatus.durationInMillisecondsMessage", values: { duration }, defaultMessage: "{duration}ms", description: "The 'ms' is an abbreviation for 'milliseconds'." }))),
