...
exports.Snapshot = ({ dangerColor, primaryColor, snapshot: { up, down, total, histogram }, windowWidth, }) => (react_2.default.createElement(eui_1.EuiFlexGroup, { alignItems: "baseline", gutterSize: "xl" },
    ...
    react_2.default.createElement(eui_1.EuiFlexItem, { grow: 8, style: { paddingTop: '12px', paddingRight: '12px' } },
        ...
        react_2.default.createElement(eui_1.EuiPanel, { paddingSize: "s", style: { maxHeight: '137px' } },
            histogram && (react_2.default.createElement(snapshot_histogram_1.SnapshotHistogram, { dangerColor: dangerColor, histogram: histogram, primaryColor: primaryColor, windowWidth: windowWidth })),
            !histogram && (react_2.default.createElement(eui_1.EuiEmptyPrompt, { title: react_2.default.createElement(eui_1.EuiTitle, null,
                    ...
                    react_2.default.createElement(react_1.FormattedMessage, { id: "xpack.uptime.snapshot.noDataDescription", defaultMessage: "Sorry, there is no data available for the histogram" })) }))))));
