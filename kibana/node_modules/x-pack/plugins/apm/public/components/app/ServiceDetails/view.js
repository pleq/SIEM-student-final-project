        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(eui_1.EuiFlexGroup, { justifyContent: "spaceBetween" },
                ...
                react_1.default.createElement(eui_1.EuiFlexItem, { grow: false },
                    react_1.default.createElement(ServiceIntegrations_1.ServiceIntegrations, { location: this.props.location, urlParams: urlParams }))),
            react_1.default.createElement(eui_1.EuiSpacer, null),
            react_1.default.createElement(FilterBar_1.FilterBar, null),
            react_1.default.createElement(serviceDetails_1.ServiceDetailsRequest, { urlParams: urlParams, render: ({ data }) => (react_1.default.createElement(ServiceDetailTabs_1.ServiceDetailTabs, { location: location, urlParams: urlParams, transactionTypes: data.types })) })));
    }
}
