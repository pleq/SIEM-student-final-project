...
function registerTutorials(server) {
  ...
  server.registerTutorial(_cloudwatch_logs.cloudwatchLogsSpecProvider);
  server.registerTutorial(_aws_metrics.awsMetricsSpecProvider);
  server.registerTutorial(_mssql_metrics.mssqlMetricsSpecProvider);
  server.registerTutorial(_zeek_logs.zeekLogsSpecProvider);
  server.registerTutorial(_nats_metrics.natsMetricsSpecProvider);
}