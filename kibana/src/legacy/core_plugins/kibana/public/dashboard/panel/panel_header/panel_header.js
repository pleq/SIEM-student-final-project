...
function PanelHeaderUi(_a) {
    ...
    var classes = classNames('dshPanel__header', {
    ...
    return (React.createElement("div", { className: classes, "data-test-subj": "dashboardPanelHeading-" + (title || '').replace(/\s/g, '') },
        React.createElement("div", { "data-test-subj": "dashboardPanelTitle", className: "dshPanel__title dshPanel__dragger", title: title, "aria-label": intl.formatMessage({
