...
var VisualizeEmbeddable = /** @class */ (function (_super) {
    ...
    function VisualizeEmbeddable(_a) {
        var onEmbeddableStateChanged = _a.onEmbeddableStateChanged, savedVisualization = _a.savedVisualization, indexPattern = _a.indexPattern, editUrl = _a.editUrl, loader = _a.loader;
