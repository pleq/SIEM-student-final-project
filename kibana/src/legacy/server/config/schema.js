...
exports.default = () => _joi2.default.object({
  ...
  csp: _joi2.default.object({
    ...
    warnLegacyBrowsers: _joi2.default.boolean().default(true)
  }).default(),
  ...
  server: _joi2.default.object({
    ...
    ssl: _joi2.default.object({
      ...
      supportedProtocols: _joi2.default.array().items(_joi2.default.string().valid('TLSv1', 'TLSv1.1', 'TLSv1.2')).default(['TLSv1.1', 'TLSv1.2']),
  ...
  map: _joi2.default.object({
    ...
    manifestServiceUrl: _joi2.default.string().default('https://catalogue.maps.elastic.co/v7.0/manifest'),
    emsLandingPageUrl: _joi2.default.string().default('https://maps.elastic.co/v7.0')
  }).default(),
