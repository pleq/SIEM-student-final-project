...
function getSearchDsl(mappings, schema, options = {}) {
  ...
  return _extends({}, (0, _query_params.getQueryParams)(mappings, schema, namespace, type, search, searchFields, defaultSearchOperator, hasReference), (0, _sorting_params.getSortingParams)(mappings, type, sortField, sortOrder));
}