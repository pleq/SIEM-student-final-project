...
import { EuiButton, EuiFieldText, EuiFlexGroup, EuiFlexItem, EuiLink, EuiOutsideClickDetector, } from '@elastic/eui';
// @ts-ignore
...
var QueryBarUI = /** @class */ (function (_super) {
    ...
    function QueryBarUI() {
        ...
        */
        ...
        _this.onTimeChange = function (_a) {
            var start = _a.start, end = _a.end, isInvalid = _a.isInvalid, isQuickSelection = _a.isQuickSelection;
            _this.setState({
                dateRangeFrom: start,
                dateRangeTo: end,
                isDateRangeInvalid: isInvalid,
            }, function () { return isQuickSelection && _this.onSubmit(); });
        };
                        ...
                        React.createElement("form", { role: "form", name: "queryBarForm" },
                            React.createElement("div", { role: "search" },
                                React.createElement("div", { className: "kuiLocalSearchAssistedInput" },
                                    React.createElement(EuiFieldText, { placeholder: this.props.intl.formatMessage({
                                        ...
                                        }, autoComplete: "off", spellCheck: false, "aria-label": this.props.intl.formatMessage({
                                            id: 'common.ui.queryBar.searchInputAriaLabel',
                                            defaultMessage: 'Search input',
                                        }), type: "text", "data-test-subj": "queryInput", "aria-autocomplete": "list", "aria-controls": "kbnTypeahead__items", "aria-activedescendant": this.state.isSuggestionsVisible ? 'suggestion-' + this.state.index : '', role: "textbox", prepend: this.props.prepend, append: React.createElement(QueryLanguageSwitcher, { language: this.state.query.language, onSelectLanguage: this.onSelectLanguage }) })))),
    ...
    QueryBarUI.prototype.handleLuceneSyntaxWarning = function () {
        var _this = this;
        var _a = this.props, intl = _a.intl, store = _a.store;
        var _b = this.state.query, query = _b.query, language = _b.language;
        if (language === 'kuery' &&
            !store.get('kibana.luceneSyntaxWarningOptOut') &&
            doesKueryExpressionHaveLuceneSyntaxError(query)) {
            var toast_1 = toastNotifications.addWarning({
                ...
                text: (React.createElement("div", null,
                    React.createElement("p", null,
                        React.createElement(FormattedMessage, { id: "common.ui.queryBar.luceneSyntaxWarningMessage", defaultMessage: "It looks like you may be trying to use Lucene query syntax, although you\n               have Kibana Query Language (KQL) selected. Please review the KQL docs {link}.", values: {
                                link: (React.createElement(EuiLink, { href: documentationLinks.query.kueryQuerySyntax, target: "_blank" },
                                    React.createElement(FormattedMessage, { id: "common.ui.queryBar.syntaxOptionsDescription.docsLinkText", defaultMessage: "here" }))),
                            } })),
                    React.createElement(EuiFlexGroup, { justifyContent: "flexEnd", gutterSize: "s" },
                        React.createElement(EuiFlexItem, { grow: false },
                            React.createElement(EuiButton, { size: "s", onClick: function () { return _this.onLuceneSyntaxWarningOptOut(toast_1); } }, "Don't show again"))))),
            });
        }
    };
    QueryBarUI.prototype.onLuceneSyntaxWarningOptOut = function (toast) {
