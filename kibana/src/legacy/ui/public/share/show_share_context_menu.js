...
export function showShareContextMenu(_a) {
    ...
    var element = (React.createElement(I18nContext, null,
        React.createElement(EuiWrappingPopover, { id: "sharePopover", button: anchorElement, isOpen: true, closePopover: onClose, panelPaddingSize: "none", withTitle: true, anchorPosition: "downLeft" },
