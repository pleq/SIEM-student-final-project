...
var HeaderBreadcrumbs = /** @class */ (function (_super) {
    ...
    HeaderBreadcrumbs.prototype.render = function () {
        return (React.createElement(EuiHeaderBreadcrumbs, { breadcrumbs: this.getBreadcrumbs(), "data-test-subj": "breadcrumbs" }));
    };
    ...
    HeaderBreadcrumbs.prototype.getBreadcrumbs = function () {
        var breadcrumbs = this.state.breadcrumbs;
        if (breadcrumbs.length === 0 && this.props.appTitle) {
            breadcrumbs = [{ text: this.props.appTitle }];
        }
        return breadcrumbs.map(function (breadcrumb, i) { return (tslib_1.__assign({}, breadcrumb, { 'data-test-subj': classNames('breadcrumb', breadcrumb['data-test-subj'], i === 0 && 'first', i === breadcrumbs.length - 1 && 'last') })); });
    };
