...
var CoreSystem = /** @class */ (function () {
    function CoreSystem(params) {
        var _this = this;
        var rootDomElement = params.rootDomElement, browserSupportsCsp = params.browserSupportsCsp, injectedMetadata = params.injectedMetadata, requireLegacyFiles = params.requireLegacyFiles, useLegacyTestHarness = params.useLegacyTestHarness;
        ...
        this.chrome = new ChromeService({ browserSupportsCsp: browserSupportsCsp });
