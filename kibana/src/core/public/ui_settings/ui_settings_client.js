...
var UiSettingsClient = /** @class */ (function () {
    ...
    UiSettingsClient.prototype.overrideLocalDefault = function (key, newDefault) {
        ...
        if (this.cache[key].userValue == null) {
            this.update$.next({ key: key, newValue: newDefault, oldValue: prevDefault });
            this.saved$.next({ key: key, newValue: newDefault, oldValue: prevDefault });
        }
    };
    /**
     ...
     * including the key, newValue, and oldValue of the setting that changed.
     */
    UiSettingsClient.prototype.getSaved$ = function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.saved$.next({ key: key, newValue: newVal, oldValue: initialVal });
                        return [2 /*return*/, true];
                    case 3:
                        error_1 = _a.sent();
